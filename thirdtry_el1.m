...
% E=zeros(1,10);
   %（Tip radius）
k=64.554; %spring constant Al=28.234 location1=64.554 location2=61.73 210309=3.114
           % poisson ratio from others
vs = 0.38;
beta0 = 1;
error = 0;
filepath = 'Epoxy/Location_1';
addpath(filepath);
addpath('Igor2Matlab');
file = dir(filepath);
...
saveas(youngs,'Youngsmodulus_el1','fig');
saveas(heatmap,'heatmap_el1','fig');
saveas(bp,'boxplot_of_el1','fig');
save('boxel1.mat','box')
exit;
