...
% E=zeros(1,10);
   %（Tip radius）
k=3.114; %spring constant Al=28.234 location1=64.554 location2=61.73 210309=3.114
           % poisson ratio from others
vs = 0.3;
beta0 = 0.01;
error = 0;
filepath = '210309Forcecurve/ForceMap00';
addpath(filepath);
addpath('Igor2Matlab');
file = dir(filepath);
...
saveas(youngs,'Youngsmodulus_210309','fig');
saveas(heatmap,'heatmap_210309','fig');
saveas(bp,'boxplot_of_210309','fig');
save('box210309.mat','box')
exit;
